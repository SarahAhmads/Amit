...
cafe['Price Per Unit'] = cafe['Price Per Unit'].astype(int)  # Fixed: Use same column

cafe['Total Spent'] = cafe['Total Spent'].replace(['UNKNOWN', 'ERROR', 'N/A'], np.nan)
cafe['Total Spent'] = cafe['Total Spent'].astype(float)
total_spent_mean = cafe['Total Spent'].mean().round()  # Fixed: Different variable name
cafe['Total Spent'] = cafe['Total Spent'].fillna(total_spent_mean)
cafe['Total Spent'] = cafe['Total Spent'].astype(int)  # Fixed: Use same column
